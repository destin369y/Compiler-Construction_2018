...
static const yytype_uint8 yyprhs[] =
{
      ...
      26,    28,    32,    37,    40,    44,    46,    48,    50,    54,
      56,    60,    62,    66,    68,    70,    72,    74,    77,    79,
      83,    87,    90,    92,    95,    97,    99,   101
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      17,     0,    -1,    18,    -1,    28,    18,    -1,    19,    -1,
      27,    19,    -1,    18,    19,    -1,    18,    27,    19,    -1,
      21,    -1,     3,    20,     4,    -1,    21,    -1,    21,     5,
      20,    -1,    22,    23,     7,    23,    -1,    22,    23,    -1,
      22,     7,    23,    -1,    22,    -1,     8,    -1,    24,    -1,
      24,     6,    23,    -1,    25,    -1,    25,     6,    23,    -1,
      26,    -1,    26,     6,    23,    -1,    10,    -1,    11,    -1,
      12,    -1,    13,    -1,    28,    29,    -1,    29,    -1,    14,
      34,    30,    -1,    15,    34,    31,    -1,    30,    32,    -1,
      32,    -1,    31,    33,    -1,    33,    -1,    12,    -1,    11,
      -1,    11,    -1
};
...
#line 109 "iloc.y"
    {
		     first_instruction = (yyvsp[(1) - (1)].inst_ptr);
		 ;}
    break;
...
#line 113 "iloc.y"
    {
		     first_instruction = (yyvsp[(2) - (2)].inst_ptr);
		 ;}
    break;
...
#line 119 "iloc.y"
    {
		     (yyval.inst_ptr) = (yyvsp[(1) - (1)].inst_ptr);
		     EndOfList = (yyvsp[(1) - (1)].inst_ptr);
		 ;}
    break;
...
#line 124 "iloc.y"
    {
		     Label* label_definition = get_label((yyvsp[(1) - (2)].ival));
		     label_definition->target = (yyvsp[(2) - (2)].inst_ptr);
		     (yyval.inst_ptr) = (yyvsp[(2) - (2)].inst_ptr);
		     EndOfList = (yyvsp[(2) - (2)].inst_ptr);
		 ;}
    break;
...
#line 131 "iloc.y"
    {
		     EndOfList->next = (yyvsp[(2) - (2)].inst_ptr);
		     EndOfList = (yyvsp[(2) - (2)].inst_ptr);
		     (yyval.inst_ptr) = (yyvsp[(1) - (2)].inst_ptr);
		 ;}
    break;
...
#line 137 "iloc.y"
    {
		     Label* label_definition = get_label((yyvsp[(2) - (3)].ival));
		     label_definition->target = (yyvsp[(3) - (3)].inst_ptr);
		     EndOfList->next = (yyvsp[(3) - (3)].inst_ptr);
		     EndOfList = (yyvsp[(3) - (3)].inst_ptr);
		     (yyval.inst_ptr) = (yyvsp[(1) - (3)].inst_ptr);
		 ;}
    break;
...
#line 147 "iloc.y"
    {
		     ...
		     (yyval.inst_ptr)->operations = (yyvsp[(1) - (1)].op_ptr);
...
#line 153 "iloc.y"
    {
		     (yyval.inst_ptr) = malloc(sizeof(Instruction));
		     (yyval.inst_ptr)->operations = (yyvsp[(2) - (3)].op_ptr);
		     (yyval.inst_ptr)->next = NULL;
		 ;}
    break;
...
#line 165 "iloc.y"
    {
		     (yyvsp[(1) - (3)].op_ptr)->next = (yyvsp[(3) - (3)].op_ptr);
		     (yyval.op_ptr) = (yyvsp[(1) - (3)].op_ptr);
		 ;}
    break;
...
#line 172 "iloc.y"
    {
		     verify_args((yyvsp[(1) - (4)].opcode_ptr),(yyvsp[(2) - (4)].operands_ptr)->num_regs,(yyvsp[(2) - (4)].operands_ptr)->num_consts+(yyvsp[(4) - (4)].operands_ptr)->num_consts,
				 (yyvsp[(2) - (4)].operands_ptr)->num_labels+(yyvsp[(4) - (4)].operands_ptr)->num_labels,(yyvsp[(4) - (4)].operands_ptr)->num_regs);
		     (yyval.op_ptr) = malloc(sizeof(Operation));
		     (yyval.op_ptr)->opcode = (yyvsp[(1) - (4)].opcode_ptr)->name;
		     (yyval.op_ptr)->srcs = (yyvsp[(2) - (4)].operands_ptr)->regs;
		     (yyval.op_ptr)->consts = append_operands((yyvsp[(2) - (4)].operands_ptr)->consts,(yyvsp[(4) - (4)].operands_ptr)->consts);
		     (yyval.op_ptr)->labels = append_operands((yyvsp[(2) - (4)].operands_ptr)->labels,(yyvsp[(4) - (4)].operands_ptr)->labels);
		     (yyval.op_ptr)->defs = (yyvsp[(4) - (4)].operands_ptr)->regs;
		     (yyval.op_ptr)->next = NULL;
		     free((yyvsp[(2) - (4)].operands_ptr));
		     free((yyvsp[(4) - (4)].operands_ptr));
		 ;}
    break;
...
#line 186 "iloc.y"
    {
		     verify_args((yyvsp[(1) - (2)].opcode_ptr),(yyvsp[(2) - (2)].operands_ptr)->num_regs,(yyvsp[(2) - (2)].operands_ptr)->num_consts,(yyvsp[(2) - (2)].operands_ptr)->num_labels,0);
		     (yyval.op_ptr) = malloc(sizeof(Operation));
		     (yyval.op_ptr)->opcode = (yyvsp[(1) - (2)].opcode_ptr)->name;
		     (yyval.op_ptr)->srcs = (yyvsp[(2) - (2)].operands_ptr)->regs;
		     (yyval.op_ptr)->consts = (yyvsp[(2) - (2)].operands_ptr)->consts;
		     (yyval.op_ptr)->labels = (yyvsp[(2) - (2)].operands_ptr)->labels;
		     (yyval.op_ptr)->defs = NULL;
		     (yyval.op_ptr)->next = NULL;
		     free((yyvsp[(2) - (2)].operands_ptr));
		 ;}
    break;
...
#line 198 "iloc.y"
    {
		     verify_args((yyvsp[(1) - (3)].opcode_ptr),0,(yyvsp[(3) - (3)].operands_ptr)->num_consts,(yyvsp[(3) - (3)].operands_ptr)->num_labels,(yyvsp[(3) - (3)].operands_ptr)->num_regs);
		     (yyval.op_ptr) = malloc(sizeof(Operation));
		     (yyval.op_ptr)->opcode = (yyvsp[(1) - (3)].opcode_ptr)->name;
		     (yyval.op_ptr)->srcs = NULL;
		     (yyval.op_ptr)->consts = (yyvsp[(3) - (3)].operands_ptr)->consts;
		     (yyval.op_ptr)->labels = (yyvsp[(3) - (3)].operands_ptr)->labels;
		     (yyval.op_ptr)->defs = (yyvsp[(3) - (3)].operands_ptr)->regs;
		     (yyval.op_ptr)->next = NULL;
		     free((yyvsp[(3) - (3)].operands_ptr));
		 ;}
    break;
...
#line 210 "iloc.y"
    {
		     verify_args((yyvsp[(1) - (1)].opcode_ptr),0,0,0,0);
		     (yyval.op_ptr) = malloc(sizeof(Operation));
		     (yyval.op_ptr)->opcode = (yyvsp[(1) - (1)].opcode_ptr)->name;
		     (yyval.op_ptr)->srcs = NULL;
...
#line 229 "iloc.y"
    {
		     ...
		     (yyval.operands_ptr)->regs = (yyvsp[(1) - (1)].operand_ptr);
		 ;}
    break;
...
#line 235 "iloc.y"
    {
		     (yyval.operands_ptr) = (yyvsp[(3) - (3)].operands_ptr);
		     (yyval.operands_ptr)->num_regs += 1;
		     (yyvsp[(1) - (3)].operand_ptr)->next = (yyval.operands_ptr)->regs;
		     (yyval.operands_ptr)->regs = (yyvsp[(1) - (3)].operand_ptr);
		 ;}
    break;
...
#line 242 "iloc.y"
    {
		     ...
		     (yyval.operands_ptr)->consts = (yyvsp[(1) - (1)].operand_ptr);
		 ;}
    break;
...
#line 248 "iloc.y"
    {
		     (yyval.operands_ptr) = (yyvsp[(3) - (3)].operands_ptr);
		     (yyval.operands_ptr)->num_consts += 1;
		     (yyvsp[(1) - (3)].operand_ptr)->next = (yyval.operands_ptr)->consts;
		     (yyval.operands_ptr)->consts = (yyvsp[(1) - (3)].operand_ptr);
		 ;}
    break;
...
#line 255 "iloc.y"
    {
		     ...
		     (yyval.operands_ptr)->labels = (yyvsp[(1) - (1)].operand_ptr);
		 ;}
    break;
...
#line 261 "iloc.y"
    {
		     (yyval.operands_ptr) = (yyvsp[(3) - (3)].operands_ptr);
		     (yyval.operands_ptr)->num_labels += 1;
		     (yyvsp[(1) - (3)].operand_ptr)->next = (yyval.operands_ptr)->labels;
		     (yyval.operands_ptr)->labels = (yyvsp[(1) - (3)].operand_ptr);
		 ;}
    break;
